...
export async function removeBgV1(buffer) {
  try {
...
export async function uploadTmpFilesFromBuffer(buffer, filename = 'image.png') {
  let tmpPath
  try {
...
export async function removeBgV2(buffer) {
  try {
...
// Ini adalah bot naze yang dimodifikasi